...
const DICT = {
  zh: {
    ...
    'game.loading': '讀取中',
    'load.scene': '場景讀取中', 'load.sprite': '立繪讀取中', 'load.spriteDrawing': '立繪繪製中', 'load.sep': '、', 'load.thumb': '讀取中',
    ...
    'batch.startedLocal': '「{title}」開始批次生成，請保持這個頁面開啟；關閉後會暫停，下次打開網頁從中斷處接著寫',
    ...
    'archive.exporting': '正在打包進度… {pct}%', 'archive.exported': '已下載：{games} 個故事，共 {files} 個檔案',
  ...
  en: {
    ...
    'load.scene': 'Loading the scene', 'load.sprite': 'Loading portraits', 'load.spriteDrawing': 'Drawing portraits',
    'load.sep': ', ', 'load.thumb': 'Loading', 'chip.sceneError': 'Scene image failed; showing the previous one', 'chip.sceneRunning': 'Drawing the scene',
    ...
    'batch.startedLocal': 'Batch writing of "{title}" has started. Keep this page open; closing it pauses the batch, and it continues where it stopped the next time you open the page',
    ...
    'archive.exporting': 'Packing your progress… {pct}%', 'archive.exported': 'Downloaded: {games} stories, {files} files',
