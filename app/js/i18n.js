...
const DICT = {
  zh: {
    ...
    'game.loading': '讀取中',
    'load.scene': '場景讀取中', 'load.sprite': '立繪讀取中', 'load.spriteDrawing': '立繪繪製中', 'load.sep': '、',
  ...
  en: {
    ...
    'load.sep': ', ', 'chip.sceneError': 'Scene image failed; showing the previous one', 'chip.sceneRunning': 'Drawing the scene',
